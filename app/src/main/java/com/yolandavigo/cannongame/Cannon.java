...
public class Cannon {
   private final int baseRadius; // Cannon base's radius
   private final int barrelLength; // Cannon barrel's length
   private final Point barrelEnd = new Point(); // endpoint of Cannon's barrel
   private double barrelAngle; // angle of the Cannon's barrel
   private Cannonball cannonball; // the Cannon's Cannonball
   private final Paint paint = new Paint(); // Paint used to draw the cannon
   private final CannonView view; // view containing the Cannon
